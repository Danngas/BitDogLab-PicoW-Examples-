...
Este repositório apresenta um projeto para tocar melodias utilizando a placa **BitDogLab**, que possui um buzzer embutido. O código implementa a execução da música "Parabens Par Voce", utilizando o controle de PWM (Pulse Width Modulation) para reproduzir as notas musicais.
...
[Simulação no Wokwi](https://wokwi.com/projects/420792959077116929)
