...
// Melodia: Baby Elephant Walk
int melodia[] = {
  NOTE_C4, NOTE_E4, NOTE_G4, NOTE_C5, NOTE_E5, NOTE_D5, NOTE_C5, NOTE_A4,
  NOTE_FS4, NOTE_G4, PAUSA, PAUSA,
  NOTE_C4, NOTE_E4, NOTE_G4, NOTE_C5, NOTE_E5, NOTE_D5, NOTE_C5, NOTE_A4,
  NOTE_G4, NOTE_A4, NOTE_DS4,

  NOTE_A4,
  NOTE_E4, NOTE_C4, PAUSA, PAUSA,
  NOTE_C4, NOTE_E4, NOTE_G4, NOTE_C5, NOTE_E5, NOTE_D5, NOTE_C5, NOTE_A4,
  NOTE_FS4, NOTE_G4, PAUSA, PAUSA, PAUSA, NOTE_G4,
  NOTE_D5, NOTE_D5, NOTE_B4, NOTE_G4, PAUSA, NOTE_G4,

  NOTE_C5, NOTE_C5, NOTE_AS4, NOTE_C5, NOTE_AS4, NOTE_G4, NOTE_F4, NOTE_DS4,
  NOTE_FS4, NOTE_FS4, NOTE_F4, NOTE_G4, NOTE_F4, NOTE_DS4, NOTE_C4, NOTE_G4,
  NOTE_AS4, NOTE_C5, PAUSA, PAUSA
};
