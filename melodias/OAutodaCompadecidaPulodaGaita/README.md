...
Este repositório apresenta um projeto para tocar melodias utilizando a placa **BitDogLab**, que possui um buzzer embutido. O código implementa a execução da música "Pulo da Gaita O Auto da Compadecida", utilizando o controle de PWM (Pulse Width Modulation) para reproduzir as notas musicais.
