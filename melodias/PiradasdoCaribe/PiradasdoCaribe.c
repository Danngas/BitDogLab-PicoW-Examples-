...
int melodia[] = {
  NOTE_E4, NOTE_G4, NOTE_A4, NOTE_A4, PAUSA,
  NOTE_A4, NOTE_B4, NOTE_C5, NOTE_C5, PAUSA,
  NOTE_C5, NOTE_D5, NOTE_B4, NOTE_B4, PAUSA,
  NOTE_A4, NOTE_G4, NOTE_A4, PAUSA,
  ...
  NOTE_E4, NOTE_G4, NOTE_A4, NOTE_A4, PAUSA,
  NOTE_A4, NOTE_C5, NOTE_D5, NOTE_D5, PAUSA,
  NOTE_D5, NOTE_E5, NOTE_F5, NOTE_F5, PAUSA,
  NOTE_E5, NOTE_D5, NOTE_E5, NOTE_A4, PAUSA,
  
  NOTE_A4, NOTE_B4, NOTE_C5, NOTE_C5, PAUSA,
  NOTE_D5, NOTE_E5, NOTE_A4, PAUSA,
  NOTE_A4, NOTE_C5, NOTE_B4, NOTE_B4, PAUSA,
  NOTE_C5, NOTE_A4, NOTE_B4, PAUSA,
  ...
  NOTE_E5, PAUSA, PAUSA, NOTE_F5, PAUSA, PAUSA,
  NOTE_E5, NOTE_E5, PAUSA, NOTE_G5, PAUSA, NOTE_E5, NOTE_D5, PAUSA, PAUSA,
  NOTE_D5, PAUSA, PAUSA, NOTE_C5, PAUSA, PAUSA,
  NOTE_B4, NOTE_C5, PAUSA, NOTE_B4, PAUSA, NOTE_A4,
...
const int compasso = 900; // Compasso que altera a duração das notas
